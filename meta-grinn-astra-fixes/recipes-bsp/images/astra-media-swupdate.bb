SUMMARY = "SWUpdate image for astra-media"
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

SYNA_SDK_VERSION = "1.7.0"
SYNA_IMAGE_NAME = "astra-media"
SWU_IMAGE_GENERATION = "swupdate-image-generation"
...
SWUPDATE_CMS_KEY = "${THISDIR}/${SWU_IMAGE_GENERATION}/demo.key.pem"
SWUPDATE_CMS_CERT = "${THISDIR}/${SWU_IMAGE_GENERATION}/demo.cert.pem"
